...
const playlist = [
  {
    src: 'https://www.youtube.com/watch?v=OQqZVRn1mWM',
    label: 'Stick To Your Guns (Youtube)',
  },
  ...
  render() {
    ...
    return (
      <div>
        ...
        <AudioPlayer src={this.state.audioSource} />
        <button
          onClick={() => this.setState({ audioSource: '/audio/armstrong.mp3' })}
        >
          Armstrong
        </button>
        <button
          onClick={() => this.setState({ audioSource: '/audio/mono.m4a' })}
        >
          Mono
        </button>
        <button
          onClick={() => this.setState({ audioSource: '/audio/click.mp3' })}
        >
          Click
        </button>
