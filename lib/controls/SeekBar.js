...
var SeekBar = /*#__PURE__*/function (_Component) {
  ...
  function SeekBar() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_isPlayingOnMouseDown", false);
    _defineProperty(_assertThisInitialized(_this), "_onChangeUsed", false);
    _defineProperty(_assertThisInitialized(_this), "_handleMouseDown", function () {
      _this._isPlayingOnMouseDown = _this.props.media.isPlaying;
      _this.props.media.pause();
    });
    _defineProperty(_assertThisInitialized(_this), "_handleMouseUp", function (_ref) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_handleChange", function (_ref2) {
...
var _default = exports["default"] = (0, _withMediaProps["default"])(SeekBar);
